...
- (void)keyboardChangeFrame:(NSNotification*)notification {
    ...
    CGRect rectAbs = [self relativeFrameForScreenWithView:firstResponder];
    
    CGFloat totalHeight = _keyboardRect.size.height + rectAbs.origin.y+rectAbs.size.height;
    
    NSLog(@"totalHeight:%@", @(totalHeight));
    NSLog(@"mainScreen Height:%@", @([UIScreen mainScreen].bounds.size.height));
